    ...
    <div class="homepage-points-wrapper">
    	<div class="container">
			<div class="row">
				...
				<div class="col-sm-4">
					<a href="/recipes/index"><img class="img-circle" src="/img/tiny-chip.png" alt="Chocolate Chip Cookie" width="140" height="140"></a>
					<a href="/recipes/index"><h2 class="homepage-heading">Discover</h2></a>
